...
def filter_by_state(list_:  List[Dict[str, Any]], default_parameter='EXECUTED') -> list[Any]:
...
def sort_by_date(list_:  List[Dict[str, Any]], default_parameter=True) -> list[Any]:
